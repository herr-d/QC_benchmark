from projectq.backends import SimpleExporter
import projectq
...
def test_simple():
    eng = projectq.MainEngine(engine_list = [], backend=SimpleExporter(output="test_simple_case1"))
...
def test_simple2():
    eng = projectq.MainEngine(engine_list = [], backend=SimpleExporter(output="test_simple_case2"))
    qubit1 = eng.allocate_qubit()
    qubit2 = eng.allocate_qubit()
