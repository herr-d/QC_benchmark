import projectq
from projectq.cengines import PermutePi4Front, MultiqubitMeasurementCliffordEngine,BasisRotation,LocalOptimizer
from projectq.ops import *
from projectq.backends import SimpleExporter, FastHeuristicLayout, CommandPrinter
...
def generate_instructions():
	...
	eng = projectq.MainEngine(backend=SimpleExporter(output = "perceptron_instructions"), engine_list=engines, verbose=True)
